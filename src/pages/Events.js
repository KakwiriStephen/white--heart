...
const UpcomingEvent = styled.div`
  background:
    ...
    url("https://i.pinimg.com/1200x/a4/df/08/a4df08d3e1bee4dc4307faad62359c91.jpg")
      no-repeat center center;
  background-size: cover;
  border-radius: 10px;
  padding: 40px;
      ...
      <EventsSection>
        <Container>
          <div className="section-title">
            ...
            <p>
              Participate in our upcoming events to support our causes, connect
              with like-minded individuals, and make a difference in communities
              around the world.
            </p>
          </div>
          ...
          <Row className="mt-5 text-center">
            <Col>
              ...
              <p className="mt-3">
                We're planning more exciting events for the upcoming months.
